...
out = csv.DictWriter(open('C:\\Users\\subhash\\Documents\\subhash\\interests\\C_Study\Project\\whatdoyouknow\\grockit_all_data\\data.csv','w'),{'qsid_track':'qsid_track','numentr_track':'numentr_track','aveplayers_track':'aveplayers_track','track_name':'track_name','game_type':'game_type','subtrack_name':'subtrack_name','correct':'correct'}, lineterminator='\n')
